...
public class SignAndVerifySignature extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_pkcs7 = new javax.swing.JTextField();
        btn_search_pkcs7 = new javax.swing.JButton();
        txt_root_pkcs7 = new javax.swing.JTextField();
        btn_search_root_pkcs7 = new javax.swing.JButton();
        jLabel8 = new javax.swing.JLabel();
        btn_verify_pkcs7_attached = new javax.swing.JButton();
        jScrollPane3 = new javax.swing.JScrollPane();
        txtAreaLog_attached = new javax.swing.JTextArea();
        ...
        jLabel7.setText("File PKCS7");

        txt_pkcs7.setEditable(false);
        txt_pkcs7.setName("txt_pkcs7"); // NOI18N

        btn_search_pkcs7.setText("CARI");
        btn_search_pkcs7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_search_pkcs7ActionPerformed(evt);
            }
        });

        txt_root_pkcs7.setEditable(false);

        btn_search_root_pkcs7.setText("CARI");
        btn_search_root_pkcs7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_search_root_pkcs7ActionPerformed(evt);
            }
        });

        jLabel8.setText("Root Cert");

        btn_verify_pkcs7_attached.setText("Verify");
        btn_verify_pkcs7_attached.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_verify_pkcs7_attachedActionPerformed(evt);
            }
        });

        txtAreaLog_attached.setColumns(20);
        txtAreaLog_attached.setRows(5);
        jScrollPane3.setViewportView(txtAreaLog_attached);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btn_verify_pkcs7_attached, javax.swing.GroupLayout.DEFAULT_SIZE, 350, Short.MAX_VALUE)
                            .addComponent(txt_pkcs7)
                            .addComponent(txt_root_pkcs7))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btn_search_root_pkcs7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btn_search_pkcs7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(txt_pkcs7, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btn_search_pkcs7))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_search_root_pkcs7)
                    .addComponent(txt_root_pkcs7, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel8))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btn_verify_pkcs7_attached)
                .addGap(18, 18, 18)
                .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
                .addContainerGap())
        );

        panelGroup.addTab("Verify Attached", jPanel1);
    ...
    private void btn_search_pkcs7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_search_pkcs7ActionPerformed
        // TODO add your handling code here:
        JFileChooser jfc = new JFileChooser(FileSystemView.getFileSystemView().getHomeDirectory());
        jfc.addChoosableFileFilter(new FileNameExtensionFilter("PKCS7 Files", "p7s"));
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            txt_pkcs7.setText(selectedFile.getAbsolutePath());
        }
    }//GEN-LAST:event_btn_search_pkcs7ActionPerformed

    private void btn_search_root_pkcs7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_search_root_pkcs7ActionPerformed
        // TODO add your handling code here:
        JFileChooser jfc = new JFileChooser(FileSystemView.getFileSystemView().getHomeDirectory());
        jfc.addChoosableFileFilter(new FileNameExtensionFilter("Certificate", "cer"));
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            txt_root_pkcs7.setText(selectedFile.getAbsolutePath());
        }
    }//GEN-LAST:event_btn_search_root_pkcs7ActionPerformed

    private void btn_verify_pkcs7_attachedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_verify_pkcs7_attachedActionPerformed
        // TODO add your handling code here:
        // TODO add your handling code here:
        PrintStream printStream = new PrintStream(new CustomOutputStream(txtAreaLog_attached));
        ...
        String signed_file = txt_pkcs7.getText();
        String root_cert_file = txt_root_pkcs7.getText();
        ...
        try {
            ...
            byte[] img_candidate = cms_control.verifyCMSNotDetached(cms_from_file);

            String target_name = FilenameUtils.removeExtension(signed_file);
            try (FileOutputStream stream = new FileOutputStream(target_name + ".jpg")) {
                stream.write(img_candidate);
            } catch (IOException ex) {
                System.out.println(ex.getMessage());
            }
            
            System.out.println("File citra disimpan di : " + target_name + ".jpg");
        } catch (IOException | UnmatchedSignatureException ex) {
            Logger.getLogger(SignAndVerifySignature.class.getName()).log(Level.SEVERE, null, ex);
            txtStatus.setText("SIGNATURE VERIFICATION FAILED");
            txtStatus.setBackground(Color.RED);
        }
        ...
        System.out.println("***END OF VERIFICATION***");
    }//GEN-LAST:event_btn_verify_pkcs7_attachedActionPerformed
...
//            }
    ...
    private javax.swing.JButton btn_search_pkcs7;
    private javax.swing.JButton btn_search_root_pkcs7;
    private javax.swing.JButton btn_verify_pkcs7_attached;
    ...
    private javax.swing.JTextArea txtAreaLog_attached;
    ...
    private javax.swing.JTextField txt_pkcs7;
    private javax.swing.JTextField txt_root_pkcs7;
